@extends('backend.layouts.app', ['activePage' => 'diamonds', 'title' => 'Edit Diamond', 'navName' => 'editdiamond', 'activeButton' => 'blog'])
...
<form action="{{ route('backend.diamonds.update', $diamond->id) }}"
            ...
            <div class="card col-md-12 mb-4">
                ...
                <div class="card-body row">
                    <div class="mb-2">
                        ...
                        <input type="text" name="mm_size" id="txtMMSize" value="{{ $diamond->mm_size }}" class="form-control">
                    </div>
                </div>
                <div class="card-body row">
                    <div class="mb-2">
                        <label for="txtXYSize" class="w-100 mb-2">XY Size:</label>
                        <input type="text" name="xy_size" id="txtXYSize" value="{{ $diamond->xy_size }}" class="form-control">
                    </div>
                </div>
                <div class="card-body row">
                    <div class="mb-2">
                        <label for="txtCaratWeight" class="w-100 mb-2">Carat Weight:</label>
                        <input type="text" name="carat_weight" id="txtCaratWeight" value="{{ $diamond->carat_weight }}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
